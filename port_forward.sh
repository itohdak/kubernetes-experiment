...
kubectl port-forward -n loadtest svc/locust-master 8089:8089 > $LOG 2> $ERROR_LOG &
kubectl port-forward -n loadtest svc/locust-master-loadtestmanager-sample 8089:8089 > $LOG 2> $ERROR_LOG &
